    	...
    	# WORKFLOW 4: or verified as already uploaded (no new game the night before)
	   	until validations[:upload_stats] == false
	   		...
	   		until validations[:last_stat_record] != nil
    			# validations[:last_stat_record] = HTTParty.get('http://localhost:2121/site/last_stat_record')
    			validations[:last_stat_record] = HTTParty.get('http://embiid21.herokuapp.com/site/last_stat_record')
